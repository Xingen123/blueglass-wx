// pages/ShopPage/ProductLibrary/index.js
...
Page({
  ...
  requestNetWork: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        that.setData({
          myProducts: res.data.data.myProducts,
  ...
  jumpHtml(e){
    console.log(e)
    wx.navigateTo({
      url: '../productWebView/html?token=' + wx.getStorageSync('token') + "&ProductDIYId=" + e.currentTarget.dataset.productdiyid + "&glassType=" + e.currentTarget.dataset.glasstype + "&minPrice=" + e.currentTarget.dataset.minprice,
    })
  },
